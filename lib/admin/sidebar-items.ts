  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'من نحن', icon: Users, href: `${basePath}/content/about` },
        { label: 'اتصل بنا', icon: Mail, href: `${basePath}/content/contact` },
        { label: 'الصفحات القانونية', icon: Shield, href: `${basePath}/content/legal` },
