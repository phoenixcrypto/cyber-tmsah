...
export const metadata: Metadata = {
  ...
  description:
    'منصة Cyber TMSAH الشاملة تجمع بين الجداول الدراسية التفاعلية والمصادر التعليمية المتخصصة ودليل الأمن السيبراني الشامل. اكتشف مسارات تعليمية منظمة، مواد دراسية حديثة، وأدوات عملية في تجربة عربية احترافية مصممة خصيصاً لطلاب ومهنيي الأمن السيبراني.',
  keywords: [
    'Cyber TMSAH',
    'الأمن السيبراني',
    'جدول المحاضرات',
