      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-dark-300 max-w-3xl mx-auto">
            Organize your academic assignments and track your learning progress
          </p>
        </div>
        ...
        <div className="text-center py-20 animate-slide-up">
          ...
          <h3 className="text-2xl sm:text-3xl font-semibold text-dark-100 mb-4">
            Advanced Assignment Management System in Development
          </h3>
          
          <p className="text-lg text-dark-300 mb-8 leading-relaxed max-w-2xl mx-auto">
            We are developing an advanced assignment and task management system. 
            It will be available soon with powerful features to organize your studies and track your progress.
          </p>
          ...
          <div className="glass-card p-8 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-dark-300">Priority-based task organization</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-cyber-green" />
                <span className="text-dark-300">Progress tracking and achievements</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-cyber-green" />
                <span className="text-dark-300">Deadline reminders and notifications</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-cyber-green" />
                <span className="text-dark-300">Points and rewards system</span>
              </div>
            </div>
          </div>
